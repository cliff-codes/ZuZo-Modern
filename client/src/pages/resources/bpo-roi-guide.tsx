...
const guideFeatures = [
  ...
  },
  {
    ...
    description: "Ready-to-use Excel template to compare your current costs with ZuZo's BPO pricing",
    icon: FileText,
  },
  {
    title: "Implementation Checklist",
    description: "Complete 30-day roadmap for successful BPO implementation and team onboarding",
    icon: ClipboardList,
  },
];
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground mb-8">
                Build a compelling business case for BPO with our comprehensive ROI calculator and implementation guide. Used by 500+ businesses to justify their outsourcing investments.
              </p>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mb-8">
                    Everything you need to calculate, justify, and present your BPO ROI to stakeholders
                  </p>
                </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm"><strong>60% cost reduction</strong> vs. in-house teams</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-success flex-shrink-0" />
                        <span className="text-sm"><strong>48-hour</strong> implementation timeline</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-success flex-shrink-0" />
                        <span className="text-sm"><strong>4.5/5 CSAT</strong> average customer satisfaction</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-primary/20">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground italic mb-4">
                      "This guide helped us build a bulletproof business case for BPO. The ROI calculator made it easy to show our CFO the exact savings we'd achieve. We implemented ZuZo and exceeded our projections."
                    </p>
                    <div className="text-sm">
                      <div className="font-semibold">Sarah Mitchell</div>
                      <div className="text-muted-foreground">COO, TechScale Solutions</div>
                    </div>
                  </CardContent>
                </Card>
              </div>
                ...
                <Card className="border-2 border-primary/20 shadow-lg">
                  <CardHeader className="text-center pb-6">
                    ...
                    <p className="text-sm text-muted-foreground pt-2">
                      Get instant access to the complete BPO ROI Calculator Guide
                    </p>
                  </CardHeader>
                  <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <p className="text-xs text-muted-foreground text-center">
                        By downloading, you agree to receive communications from ZuZo. 
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div>
                  <div className="text-3xl md:text-4xl font-bold text-primary mb-2">4.5/5</div>
