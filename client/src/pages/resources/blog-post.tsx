            ...
            {isLoading ? (
              ...
              <div className="space-y-8">
                ...
                <header className="space-y-6">
                  {post.category && (
                    <Badge variant="secondary" className="text-sm" data-testid="post-category">
                      {post.category}
                    </Badge>
                  )}
                  
                  <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl" data-testid="post-title">
                    {post.title}
                  </h1>
                  
                  {post.excerpt && (
                    <p className="text-xl text-muted-foreground" data-testid="post-excerpt">
                      {post.excerpt}
                    </p>
                  )}
              ...
              <div className="text-center py-16">
                <h2 className="font-heading font-bold text-2xl mb-4">Blog Post Not Found</h2>
