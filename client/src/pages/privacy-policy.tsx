                ...
                <div className="container mx-auto px-4 py-16 max-w-4xl">
                    ...
                    <div className="prose prose-lg max-w-none space-y-8">
                        <p className="text-lg text-muted-foreground">
                            At Zuzo, we are committed to protecting and respecting your privacy.
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                                ...
                                <li>
                                    ...
                                    and other details relevant to the services we provide.
                                </li>
                                <li>
                                    <strong>Communication data:</strong> Correspondence and
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                                ...
                                <li>
                                    <strong>Legal purposes:</strong> When required to comply with
                                    applicable laws, regulations, legal processes, or government
                                    requests.
                                </li>
                                <li>
                                    <strong>Business transfers:</strong> In the event of a merger,
                                    acquisition, or any form of transfer or sale of some or all of
                                    our assets.
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                ...
                                about significant changes by posting the updated policy on our
                                website.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                ...
                                or{' '}
                                <a
                                    href="mailto:support@zuzogp.com"
                                    className="text-primary hover:underline"
                                >
                                    support@zuzogp.com
                                </a>
