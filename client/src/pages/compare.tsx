...
import { CheckCircle, X, TrendingDown, Clock, Zap, Users, Calculator } from 'lucide-react';
                    ...
                    <div className="container mx-auto px-4 lg:px-8">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-lg lg:text-xl text-muted-foreground">
                                Make an informed decision with a side-by-side comparison of your
                                outsourcing options
                            </p>
                        </div>
                    </div>
                                    ...
                                    <CardContent className="p-0">
                                        <table className="w-full">
                                            <thead className="bg-muted/50">
                                                <tr>
                                                    <th className="text-left p-6 font-heading font-bold text-xl">
                                                        Feature
                                                    </th>
                                                        ...
                                                        >
                                                            ...
                                                            <td className="p-6 text-center">
                                                                <div className="flex items-center justify-center gap-2 mb-2">
                                                                    <X className="h-5 w-5 text-destructive" />
                                                                    <span className="font-semibold">
                                                                        {row.traditionalBPO.text}
                                                                    </span>
                                                                </div>
                                                                <div className="text-xl font-bold mb-1">
                                                                    {row.traditionalBPO.value}
                                                                </div>
                                                                <div className="text-sm text-muted-foreground">
                                                                    {row.traditionalBPO.details}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    );
                            ...
                            <CardContent className="p-8 md:p-12">
                                <div className="text-center">
                                    ...
                                    <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                                        See exactly how much you can save by switching to ZuZo. Our
                                        ROI calculator provides a detailed breakdown of your
