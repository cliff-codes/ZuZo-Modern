...
const securityFeatures = [
    ...
    },
    {
        ...
        description:
            'Role-based access control (RBAC) with multi-factor authentication and audit logging',
        icon: Eye,
    },
    {
                    ...
                    <div className="container mx-auto px-4 lg:px-8">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-lg lg:text-xl text-muted-foreground">
                                ...
                                standards of security and compliance to protect your business and
                    ...
                    <div className="container mx-auto px-4 lg:px-8">
                        <div className="max-w-3xl mx-auto text-center mb-12">
                            ...
                            <p className="text-lg text-muted-foreground">
                                We maintain rigorous compliance certifications to ensure the highest
                                    ...
                                    <CardContent className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p className="text-muted-foreground">
                                                <strong>Encryption at Rest:</strong> All data is
                                                encrypted using AES-256 encryption with regularly
                                                rotated keys
                                            </p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Encryption in Transit:</strong> TLS 1.3
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p className="text-muted-foreground">
                                                ...
                                                authentication and role-based access with audit
                                                trails
                                            </p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Security Audits:</strong> Regular
                                                third-party penetration testing and vulnerability
                                                assessments
                                            </p>
                                        </div>
                                    </CardContent>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Secure Data Centers:</strong> SOC 2
                                                certified facilities with 24/7 physical security and
                                                monitoring
                                            </p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Redundancy:</strong> Multi-region data
                                                replication with automatic failover capabilities
                                            </p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Backup & Recovery:</strong> Automated daily
                                                backups with 30-day retention and disaster recovery
                                                testing
                                            </p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Uptime SLA:</strong> 99.9% uptime guarantee
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Privacy Policy:</strong> Comprehensive data
                                                protection policies compliant with global
                                                regulations
                                            </p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Data Processing:</strong> Clear data
                                                processing agreements (DPAs) for all client
                                                engagements
                                            </p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle className="h-5 w-5 text-success mt-0.5 flex-shrink-0" />
                                            <p className="text-muted-foreground">
                                                <strong>Employee Training:</strong> Mandatory
                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            <Accordion type="single" collapsible className="space-y-4">
                                {securityFAQs.map((faq, index) => (
                                    ...
                                    >
                                        <AccordionTrigger
                                            className="font-heading font-semibold hover:no-underline"
                            ...
                            <CardContent className="p-8 md:p-12">
                                <div className="text-center">
                                    ...
                                    <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                                        Our security team is here to answer your questions and
                                        provide detailed information about our security practices
