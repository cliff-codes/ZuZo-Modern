                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-sm text-gray-300 leading-relaxed mb-6 max-w-md">
                            Transforming business operations with AI-powered virtual assistants and
                            omnichannel contact center solutions. Trusted by 500+ businesses
                            worldwide.
                        </p>
                        <div className="space-y-3">
                            <div className="flex items-start gap-3 text-sm">
                                ...
                                <span className="text-gray-300">
                                    ...
                                    <br />
                                    29 Independence Avenue, 1st Floor
                                    <br />
                                    Accra, Ghana
                                </span>
                            </div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link
                                    ...
                                    data-testid="footer-link-contact-center"
                                >
                                    Contact Center
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="block py-1.5 text-sm text-gray-300 hover:text-white transition-colors"
                                    data-testid="footer-link-virtual-assistants"
                                >
                                    Virtual Assistants
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="block py-1.5 text-sm text-gray-300 hover:text-white transition-colors"
                                    data-testid="footer-link-ai-automation"
                                >
                                    AI & Automation
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="block py-1.5 text-sm text-gray-300 hover:text-white transition-colors"
                                    data-testid="footer-link-back-office"
                                >
                                    Back Office
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="block py-1.5 text-sm text-gray-300 hover:text-white transition-colors"
                                    data-testid="footer-link-workforce"
                                >
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link
                                    href="/roi-calculator"
                                    className="block py-1.5 text-sm text-gray-300 hover:text-white transition-colors"
                                    data-testid="footer-link-roi-calculator"
                                >
                                    ROI Calculator
                                </Link>
                            </li>
                            <li>
                                <Link
                                    href="/book-demo"
                                    className="block py-1.5 text-sm text-gray-300 hover:text-white transition-colors"
                                    data-testid="footer-link-book-demo"
                                >
                                    Book Demo
                                </Link>
                            </li>
                ...
                <div className="mt-12 pt-8 border-t border-gray-800">
                    <div className="max-w-md">
                        ...
                        <p className="text-sm text-gray-300 mb-4">
                            Get the latest insights on BPO, AI automation, and business
                            optimization.
                        </p>
                        <NewsletterSignup />
                    </div>
